...
<table width="50%" align="left" cellspacing="1" cellpadding="5">
  ...
  <tr>
   ...
   <td>:
  <input checked="checked" type="radio" name="gender" value="Laki - Laki"><font color=white>male
  <input type="radio" name="gender" value="Perempuan"><font color=white>female
